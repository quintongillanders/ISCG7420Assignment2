...
WSGI_APPLICATION = 'quinton_2.wsgi.application'
...
# For Vercel Postgres (if you set up a Vercel Postgres database)
...
EMAIL_HOST_PASSWORD = 'uzqnjorqyfzblvio'
